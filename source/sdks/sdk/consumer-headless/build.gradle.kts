...
mavenPublishing {
    pom {
        name.set("Stytch Consumer SDK")
        description.set("Stytch headless Consumer authentication SDK for Android, iOS, JVM, and React Native")
    }
}
...
kotlin {
    ...
    compilerOptions {
        ...
        freeCompilerArgs.addAll("-Xenable-suspend-function-exporting", "-Xexpect-actual-classes", "-Xbinary=bundleId=$group.consumer", "-Xexport-kdoc")
    }
