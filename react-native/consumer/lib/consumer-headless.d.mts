...
export declare class BiometricsAuthenticateResponse implements StytchAPIResponse, AuthenticatedResponse {
    ...
    get session(): ApiSessionV1Session;
    ...
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: StytchAPIResponse["__doNotUseOrImplementIt"] & AuthenticatedResponse["__doNotUseOrImplementIt"];
}
...
export declare interface StytchConsumer extends StytchClient {
    readonly otp: OtpClient;
    readonly session: SessionClient;
    readonly crypto: CryptoClient;
    readonly magicLinks: MagicLinksClient;
    readonly totp: TOTPClient;
    readonly passwords: PasswordsClient;
    readonly user: UserClient;
    readonly passkeys: PasskeysClient;
    readonly biometrics: BiometricsClient;
    readonly oauth: OAuthClient;
    readonly dfp: DFPClient;
    readonly authenticationStateFlow: any/* StateFlow<ConsumerAuthenticationState> */;
    authenticationStateObserver(callback: (p0: ConsumerAuthenticationState) => void): JsCleanup;
    ...
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.StytchConsumer": unique symbol;
    } & StytchClient["__doNotUseOrImplementIt"];
}
export declare function createStytchConsumer(configuration: StytchClientConfiguration): StytchConsumer;
export declare interface BiometricsClient {
    register(parameters: BiometricsParameters): Promise<BiometricsRegisterResponse>;
    authenticate(parameters: BiometricsParameters): Promise<BiometricsAuthenticateResponse>;
    removeRegistration(): Promise<boolean>;
    getAvailability(parameters: BiometricsParameters): Promise<any/* BiometricsAvailability */>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.biometrics.BiometricsClient": unique symbol;
    };
}
export declare interface CryptoClient {
    authenticate(request: CryptoWalletsAuthenticateParameters, signChallenge: any /*Suspend functions are not supported*/): Promise<CryptoWalletsAuthenticateResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.crypto.CryptoClient": unique symbol;
    };
}
export declare abstract class ConsumerAuthenticationState /* implements AuthenticationState */ {
    protected constructor();
}
export declare namespace ConsumerAuthenticationState {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => ConsumerAuthenticationState;
    }
    class Loading extends ConsumerAuthenticationState.$metadata$.constructor {
        constructor();
    }
    namespace Loading {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    ...
    class Unauthenticated extends ConsumerAuthenticationState.$metadata$.constructor {
        constructor();
    }
    ...
    class Authenticated extends ConsumerAuthenticationState.$metadata$.constructor {
        constructor(user: ApiUserV1User, session: ApiSessionV1Session, sessionToken: string, sessionJwt: string);
        get user(): ApiUserV1User;
        get session(): ApiSessionV1Session;
        get sessionToken(): string;
        get sessionJwt(): string;
...
export declare abstract class ConsumerTokenType {
    private constructor();
    static get MAGIC_LINKS(): ConsumerTokenType & {
        get name(): "MAGIC_LINKS";
        get ordinal(): 0;
    };
    static get OAUTH(): ConsumerTokenType & {
        get name(): "OAUTH";
        get ordinal(): 1;
    };
    static get RESET_PASSWORD(): ConsumerTokenType & {
        get name(): "RESET_PASSWORD";
        get ordinal(): 2;
    };
    static get UNKNOWN(): ConsumerTokenType & {
        get name(): "UNKNOWN";
        get ordinal(): 3;
    };
    get name(): "MAGIC_LINKS" | "OAUTH" | "RESET_PASSWORD" | "UNKNOWN";
    get ordinal(): 0 | 1 | 2 | 3;
    static values(): Array<ConsumerTokenType>;
    static valueOf(value: string): ConsumerTokenType;
}
export declare namespace ConsumerTokenType {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => ConsumerTokenType;
    }
}
...
export declare namespace DeeplinkAuthenticationStatus {
    ...
    class Authenticated extends DeeplinkAuthenticationStatus.$metadata$.constructor {
        constructor(response: AuthenticatedResponse);
    }
    namespace Authenticated {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
...
export declare interface DFPClient {
    ...
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.dfp.DFPClient": unique symbol;
    };
}
export declare interface MagicLinksClient {
    readonly email: EmailMagicLinksClient;
    authenticate(request: MagicLinksAuthenticateParameters): Promise<MagicLinksAuthenticateResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.magicLinks.MagicLinksClient": unique symbol;
    };
}
export declare interface EmailMagicLinksClient {
    loginOrCreate(request: MagicLinksEmailLoginOrCreateParameters): Promise<MagicLinksEmailLoginOrCreateResponse>;
    send(request: MagicLinksEmailSendSecondaryParameters): Promise<MagicLinksEmailSendSecondaryResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.magicLinks.EmailMagicLinksClient": unique symbol;
    };
}
export declare interface AuthenticatedResponse {
    readonly user: ApiUserV1User;
    readonly sessionToken: string;
    readonly session: ApiSessionV1Session;
    readonly sessionJwt: string;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.networking.AuthenticatedResponse": unique symbol;
    };
}
export declare interface OAuthClient {
    authenticate(request: OAuthAuthenticateParameters): Promise<OAuthAuthenticateResponse>;
    authenticateGoogleIdToken(request: OAuthGoogleIDTokenAuthenticateParameters): Promise<OAuthGoogleIDTokenAuthenticateResponse>;
    authenticateAppleIdToken(request: OAuthAppleIDTokenAuthenticateParameters): Promise<OAuthGoogleIDTokenAuthenticateResponse>;
    attach(request: OAuthAttachParameters): Promise<OAuthAttachResponse>;
    readonly apple: OAuthType;
    readonly amazon: OAuthType;
    readonly bitbucket: OAuthType;
    readonly coinbase: OAuthType;
    readonly discord: OAuthType;
    readonly facebook: OAuthType;
    readonly figma: OAuthType;
    readonly github: OAuthType;
    readonly gitlab: OAuthType;
    readonly google: OAuthType;
    readonly linkedin: OAuthType;
    readonly microsoft: OAuthType;
    readonly salesforce: OAuthType;
    readonly slack: OAuthType;
    readonly snapchat: OAuthType;
    readonly tiktok: OAuthType;
    readonly twitch: OAuthType;
    readonly twitter: OAuthType;
    readonly yahoo: OAuthType;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.oauth.OAuthClient": unique symbol;
    };
}
export declare interface OAuthType {
    start(startParameters: OAuthStartParameters): Promise<AuthenticatedResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.oauth.OAuthType": unique symbol;
    };
}
export declare interface OtpClient {
    readonly sms: SmsOtpClient;
    readonly email: EmailOtpClient;
    readonly whatsapp: WhatsAppOtpClient;
    authenticate(request: OTPsAuthenticateParameters): Promise<OTPsAuthenticateResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.otp.OtpClient": unique symbol;
    };
}
export declare interface SmsOtpClient {
    loginOrCreate(request: OTPsSMSLoginOrCreateParameters): Promise<OTPsSMSLoginOrCreateResponse>;
    send(request: OTPsSMSSendSecondaryParameters): Promise<OTPsSMSSendSecondaryResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.otp.SmsOtpClient": unique symbol;
    };
}
export declare interface EmailOtpClient {
    loginOrCreate(request: OTPsEmailLoginOrCreateParameters): Promise<OTPsEmailLoginOrCreateResponse>;
    send(request: OTPsEmailSendSecondaryParameters): Promise<OTPsEmailSendSecondaryResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.otp.EmailOtpClient": unique symbol;
    };
}
export declare interface WhatsAppOtpClient {
    loginOrCreate(request: OTPsWhatsAppLoginOrCreateParameters): Promise<OTPsWhatsAppLoginOrCreateResponse>;
    send(request: OTPsWhatsAppSendSecondaryParameters): Promise<OTPsWhatsAppSendSecondaryResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.otp.WhatsAppOtpClient": unique symbol;
    };
}
export declare interface PasskeysClient {
    readonly isSupported: boolean;
    register(parameters: PasskeysParameters): Promise<WebAuthnRegisterResponse>;
    authenticate(parameters: PasskeysParameters): Promise<WebAuthnAuthenticateResponse>;
    update(id: string, request: WebAuthnUpdateParameters): Promise<WebAuthnUpdateResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.passkeys.PasskeysClient": unique symbol;
    };
}
export declare interface PasswordsClient {
    authenticate(request: PasswordsAuthenticateParameters): Promise<PasswordsAuthenticateResponse>;
    create(request: PasswordsCreateParameters): Promise<PasswordsCreateResponse>;
    resetByEmailStart(request: PasswordsEmailResetStartParameters): Promise<PasswordsEmailResetStartResponse>;
    resetByEmail(request: PasswordsEmailResetParameters): Promise<PasswordsEmailResetResponse>;
    resetByExistingPassword(request: PasswordsExistingPasswordResetParameters): Promise<PasswordsExistingPasswordResetResponse>;
    resetBySession(request: PasswordsSessionResetParameters): Promise<PasswordsSessionResetResponse>;
    strengthCheck(request: PasswordsStrengthCheckParameters): Promise<PasswordsStrengthCheckResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.passwords.PasswordsClient": unique symbol;
    };
}
export declare interface SessionClient {
    authenticate(request: SessionsAuthenticateParameters): Promise<SessionsAuthenticateResponse>;
    revoke(): Promise<SessionsRevokeResponse>;
    attest(request: SessionsAttestParameters): Promise<SessionsAttestResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.session.SessionClient": unique symbol;
    };
}
export declare interface TOTPClient {
    create(request: TOTPsCreateParameters): Promise<TOTPsCreateResponse>;
    authenticate(request: TOTPsAuthenticateParameters): Promise<TOTPsAuthenticateResponse>;
    recover(request: TOTPsRecoverParameters): Promise<TOTPsRecoverResponse>;
    recoveryCodes(): Promise<TOTPsGetRecoveryCodesResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.totp.TOTPClient": unique symbol;
    };
}
export declare interface UserClient {
    getUser(): Promise<GetMeResponse>;
    deleteFactor(factor: AuthenticationFactor): Promise<DeleteFactorResponse>;
    update(request: UpdateMeParameters): Promise<UpdateMeResponse>;
    readonly __doNotUseOrImplementIt: {
        readonly "com.stytch.sdk.consumer.user.UserClient": unique symbol;
    };
}
export declare abstract class AuthenticationFactor {
    protected constructor(factorId: string);
    get factorId(): string;
}
export declare namespace AuthenticationFactor {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => AuthenticationFactor;
    }
    class TOTP extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.TOTP;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace TOTP {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => TOTP;
        }
    }
    class Email extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.Email;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace Email {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => Email;
        }
    }
    class OAuth extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.OAuth;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    ...
    class WebAuthn extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.WebAuthn;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace WebAuthn {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => WebAuthn;
        }
    }
    class Biometric extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.Biometric;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace Biometric {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => Biometric;
        }
    }
    class CryptoWallet extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.CryptoWallet;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace CryptoWallet {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => CryptoWallet;
        }
    }
    class PhoneNumber extends AuthenticationFactor.$metadata$.constructor {
        constructor(factorId: string);
        get factorId(): string;
        copy(factorId?: string): AuthenticationFactor.PhoneNumber;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
    }
    namespace PhoneNumber {
        /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
        namespace $metadata$ {
            const constructor: abstract new () => PhoneNumber;
        }
    }
}
export declare class DeleteFactorResponse implements BasicResponse {
    constructor(requestId: string, statusCode: number, user: ApiUserV1User);
    get requestId(): string;
    get statusCode(): number;
    get user(): ApiUserV1User;
    copy(requestId?: string, statusCode?: number, user?: ApiUserV1User): DeleteFactorResponse;
    toString(): string;
    hashCode(): number;
    equals(other: Nullable<any>): boolean;
    readonly __doNotUseOrImplementIt: BasicResponse["__doNotUseOrImplementIt"];
}
export declare namespace DeleteFactorResponse {
    /** @deprecated $metadata$ is used for internal purposes, please don't use it in your code, because it can be removed at any moment */
    namespace $metadata$ {
        const constructor: abstract new () => DeleteFactorResponse;
    }
}