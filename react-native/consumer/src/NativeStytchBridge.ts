...
export interface StytchBridgeSpec extends TurboModule {
  device: {
...
const module = TurboModuleRegistry.get<StytchBridgeSpec>('StytchBridge');
...
declare global {
  var StytchBridge: StytchBridgeSpec;
}
