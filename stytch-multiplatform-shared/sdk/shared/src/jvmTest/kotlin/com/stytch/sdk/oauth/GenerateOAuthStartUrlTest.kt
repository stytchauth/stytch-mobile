...
internal class GenerateOAuthStartUrlTest {
    ...
    @Test
    fun `includes public_token and code_challenge`() =
        runTest {
            val url = generate()
    ...
    @Test
    fun `preserves the base URL path`() =
        runTest {
    ...
    @Test
    fun `includes loginRedirectUrl and signupRedirectUrl when provided`() =
        runTest {
            val url =
                generate(
                    parameters =
    ...
    @Test
    fun `joins customScopes with a space`() =
        runTest {
            val url =
                generate(
    ...
    @Test
    fun `prefixes providerParams keys with provider_`() =
        runTest {
            val url =
                generate(
                    parameters =
