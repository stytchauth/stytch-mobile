...
/// Indicates that the protected action is a Login hR1gc27D.
...
/// Indicates that the protected action is a Signup hR1gc27D.
...
/// Unknown error occurred during the hR1gc27D.
...
- (nonnull instancetype)init:(NSString * _Nonnull)mobilerlnblksm OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Newer implementations return the Token as a string.");
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
